...
function sortCarInventory(inventory) {
  /* code here */
  return inventory.sort((x, y) => (x.car_model < y.car_model) ? -1 : (x.car_model > y.car_model) ? 1 : 0)
}
 ...
 * }
*/
const sum = (n1, n2) => n1 + n2; // code here!
